...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        String currentUser = Local.getData("usuario", getApplicationContext(), "currentUser");
        ...
        if(fUser != null && sented.equals(fUser.getUid())){
            if(!currentUser.equals(user)) {
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                    ...
                    sendNotificaction(remoteMessage);
                }
            }
        }
    }
    ...
    private void sendNotificaction(RemoteMessage remoteMessage) {
